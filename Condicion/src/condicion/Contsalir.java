...
public class Contsalir {//Aqui el programa proyecta el nombre que le diste al proyecto//
...
int res;//Declaracion de variable para saber si va a querer seguir calificando//
...
do{//Las acciones que va realizar el ciclo//
 ...
 res=Integer.parseInt(JOptionPane.showInputDialog("Ingresar otro alumno"
    +"\n1)Si"
    +"\n2)No")); //Das a elegir al usuario si ya quiere salir o lo seguira ocupando//
 
}while (cont==1);//Ciclo, si el contador es diferente de 1, saldra. Si no, lo seguira ejecutando// 
}
}
